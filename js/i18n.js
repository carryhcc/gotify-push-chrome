...
const translations = {
  en: {
    ...
    statusError403:
      'Failed to send: 403 Forbidden. Invalid Token, insufficient permissions or CORS settings. Please visit <a href="https://gotify.net/docs/config" target="_blank">https://gotify.net/docs/config</a> to check GOTIFY_SERVER_CORS_ALLOWORIGINS settings and restart the server.',
  ...
  zh_CN: {
    ...
    statusError403:
      '发送失败：403 Forbidden，Token无效、权限不足或CORS配置问题。请访问 <a href="https://gotify.net/docs/config" target="_blank">https://gotify.net/docs/config</a> 查看 GOTIFY_SERVER_CORS_ALLOWORIGINS 配置项并重启服务端。',
